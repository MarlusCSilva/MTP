...
public class FrmNegativo extends javax.swing.JFrame {
    int indice = 0;
    
    ControllerCliente controlCliente = new ControllerCliente();
    
    List <CadastroCliente> lista = controlCliente.getClienteNegativo();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Cliente negativo");
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FrmNegativo().setVisible(true);
            }
        });
    }
